...
export default function Footer() {
  return (
    <footer className="bg-white text-gray-600 pt-8 sm:pt-10 pb-20 md:pb-6 font-sans border-t border-gray-200">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-8 sm:gap-10 mb-8 sm:mb-10">
          ...
          {/* Categories */}
          <div>
            <h3 className="text-gray-900 font-bold text-base sm:text-lg mb-4 sm:mb-6">Chuyên mục</h3>
            <ul className="flex flex-col gap-3 sm:gap-4 text-sm text-gray-500">
          ...
          {/* About Us */}
          <div>
            <h3 className="text-gray-900 font-bold text-base sm:text-lg mb-4 sm:mb-6">Về chúng tôi</h3>
            <ul className="flex flex-col gap-3 sm:gap-4 text-sm text-gray-500">
          ...
          {/* Contact Info */}
          <div>
            <h3 className="text-gray-900 font-bold text-base sm:text-lg mb-4 sm:mb-6">Liên hệ</h3>
            <ul className="flex flex-col gap-4 sm:gap-5 text-sm">
        ...
        {/* Bottom Bar */}
        <div className="border-t border-gray-200 pt-5 sm:pt-6 flex flex-col md:flex-row justify-between items-center gap-3 sm:gap-4 text-xs sm:text-sm text-gray-500">
