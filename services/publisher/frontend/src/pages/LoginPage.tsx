    ...
    <div className="min-h-screen bg-white flex items-center justify-center">
      <div className="w-full max-w-sm mx-auto px-6">
        ...
        <div className="flex flex-col items-center mb-10">
          ...
          <p className="text-gray-400 text-sm mt-1.5">Publisher Admin</p>
        </div>
        ...
        <div className="bg-white border border-gray-200 rounded-2xl p-6 shadow-sm">
          ...
          <form onSubmit={handleSubmit} className="space-y-3">
            <div>
              ...
              <input
                ...
                required
                className="w-full px-3.5 py-2.5 rounded-xl border border-gray-200 bg-gray-50 text-sm text-gray-900 placeholder:text-gray-400 focus:outline-none focus:border-[#2563eb] focus:ring-1 focus:ring-[#2563eb]/20 transition-all"
              />
            </div>
            <div>
            ...
            <button
              ...
              className="w-full px-4 py-2.5 rounded-xl bg-[#2563eb] text-white font-medium text-sm hover:bg-blue-700 transition-all disabled:opacity-50 disabled:cursor-not-allowed"
            >
          ...
          <button
            ...
            disabled={isLoading}
            className="w-full flex items-center justify-center gap-3 px-4 py-2.5 rounded-xl border border-gray-200 bg-white text-gray-800 font-medium text-sm hover:bg-gray-50 hover:border-gray-300 transition-all disabled:opacity-50"
          >
