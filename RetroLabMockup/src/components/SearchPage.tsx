      ...
      <div className="bg-[#f8f9fa] border-b border-gray-200 py-12 md:py-20">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="relative max-w-2xl mx-auto">
            ...
            <button className="absolute right-2 top-1/2 -translate-y-1/2 bg-[#2563eb] text-white px-6 py-2 md:py-3 rounded-full font-bold text-sm hover:bg-blue-700 transition-colors">
              Tìm
            </button>
          </div>
        </div>
