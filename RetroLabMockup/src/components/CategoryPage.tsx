          ...
          <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
            ...
            <div className="lg:col-span-2">
              <div className="group cursor-pointer h-full flex flex-col items-center text-center">
                <div className="relative w-full mb-4 h-full min-h-[300px]">
                  ...
                  <div className="absolute -bottom-3 left-1/2 -translate-x-1/2 z-10">
                    <span className="bg-[#2563eb] text-white text-[10px] font-bold px-3 py-1.5 rounded-full uppercase tracking-wider whitespace-nowrap">Góc nhìn</span>
                  </div>
                </div>
                <h3 className="text-xl md:text-2xl font-sans font-bold leading-snug mt-2 group-hover:text-gray-300 transition-colors px-4">Giải đáp các câu hỏi thường gặp về Privacy Display trên Galaxy S26 Ultra</h3>
              </div>
            </div>
